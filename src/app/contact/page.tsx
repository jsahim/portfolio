      ...
      <h1 className="font-fugaz text-6xl text-[#e98522] text-center m-5 mb-16">Contact</h1>
        ...
        <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
          <form action="https://formsubmit.co/jeffreysahim@gmail.com" method="POST" className="space-y-8">
              <div>
                  <label htmlFor="name" className="block mb-2 text-sm font-regular text-gray-90">Your name</label>
              ...
              <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-regular text-gray-900">Your email</label>
              ...
              <div className="sm:col-span-2">
                  <label htmlFor="message" className="block mb-2 text-sm font-regular text-gray-900">Your message</label>
              ...
              <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-[#304962] sm:w-fit hover:bg-[#e98522] transition-all duration-150 ease-in">SEND MESSAGE</button>
          </form>
        </div>
