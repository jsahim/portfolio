  ...
  return (
      <div className="w-[85%] h-full text-center"> 
        <h1 className="font-fugaz text-[#304962] my-3">
          ...
          { nameReady || origin ? <><span className={`relative z-[-1] ${ !origin ? "animate-refine-slidein" : ""} leading-relaxed ${orangeReady ? "text-[#e98522] text-[15vw]": "text-[9vw]"} ${orangeReady && !origin ? "duration-700": ""}`}>Jeff Sahim</span><br/></> : null }
