...
export default function Skills() {
  ...
  const [currSite, setCurrSite] = useState<string>("")
    ...
    const chatGPT = (<a key="chatGPT" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://chatgpt.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">ChatGPT</span>
    ...
    const githubCopilot = (<a key="githubCopilot" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://github.com/features/copilot" target="_blank" rel="noreferrer">
    ...
    const claude = (<a key="claude" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://claude.ai/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Claude</span>
    ...
    const tableau = (<a key="tableau" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.tableau.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Tableau</span>
    ...
    const slack = (<a key="slack" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://slack.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Slack</span>
    ...
    const notion = (<a key="notion" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://slack.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Notion</span>
      <div className="w-36 h-36 flex justify-center items-center group-hover:text-[#e98522] text-black">
        <SiNotion className="w-36 h-36 z-2 group-hover:w-24 transition-all duration-150 ease-in" />
      </div>
    </a>)

    const googleDocs = (<a key="googleDocs" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://docs.google.com" target="_blank" rel="noreferrer">
    ...
    const googleAnalytics = (<a key="googleAnalytics" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://marketingplatform.google.com/about/analytics/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Google<br/>Analytics</span>
    ...
    const confluence = (<a key="confluence" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.atlassian.com/software/confluence" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Confluence</span>
    ...
    const trello = (<a key="trello" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.atlassian.com/software/trello" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Trello</span>
      <div className="w-36 h-36 flex justify-center items-center group-hover:text-[#e98522] text-[#0053CD]">
        <FaTrello className="w-36 h-36 z-2 group-hover:w-24 transition-all duration-150 ease-in" />
      </div>
    </a>)

    const jira = (<a key="jira" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.atlassian.com/software/jira" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">JIRA</span>
      <div className="w-36 h-36 flex justify-center items-center group-hover:text-[#e98522] text-[#0053CD]">
        <SiJira className="w-36 h-36 z-2 group-hover:w-24 transition-all duration-150 ease-in" />
      </div>
    </a>)

    const sketch = (<a key="sketch" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.sketch.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Sketch</span>
    ...
    const vercel = (<a key="vercel" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://vercel.com/" target="_blank" rel="noreferrer">
    ...
    const npm = (<a key="npm" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.npmjs.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">npm</span>
    ...
    const lighthouse = (<a key="lighthouse" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://developer.chrome.com/docs/lighthouse/overview" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Lighthouse</span>
    ...
    const esLint = (<a key="esLint" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://eslint.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">ESLint</span>
    ...
    const webPack = (<a key="webPack" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://webpack.js.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Webpack</span>
    ...
    const restAPI = (<a key="restAPI" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://restfulapi.net/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">REST API</span>
    ...
    const vsCode = (<a key="vsCode" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://code.visualstudio.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">VS Code</span>
    ...
    const nextJS = (<a key="nextJS" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://nextjs.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Next.js</span>
      <div className="w-36 h-36 flex justify-center items-center group-hover:text-[#e98522] text-black">
    ...
    const typeScript = (<a key="typeScript" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.typescriptlang.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">TypeScript</span>
    ...
    const vueJS = (<a key="vueJS" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://vuejs.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Vue.js</span>
    ...
    const reactJS = (<a key="reactJS" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://react.dev/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">React</span>
    ...
    const reactRouter = (<a key="reactRouter" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://reactrouter.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">React<br/>Router</span>
    ...
    const redux = (<a key="redux" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://redux.js.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Redux</span>
    ...
    const jQuery = (<a key="jQuery" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://jquery.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">jQuery</span>
    ...
    const javaScript = (<a key="javaScript" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.javascript.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">JavaScript</span>
    ...
    const html = (<a key="html" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://html.spec.whatwg.org/multipage/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">HTML</span>
    ...
    const css = (<a key="css" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.w3.org/Style/CSS/Overview.en.html" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">CSS</span>
    ...
    const mocha = (<a key="mocha" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://mochajs.org/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Mocha</span>
    ...
    const chai = (<a key="chai" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.chaijs.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Chai</span>
    ...
    const cypress = (<a key="cypress" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.cypress.io/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Cypress</span>
    ...
    const adobeCC = (<a key="adobeCC" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.adobe.com/creativecloud.html" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Adobe<br/>Creative<br/>Cloud</span>
    ...
    const figma = (<a key="figma" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://www.figma.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Figma</span>
    ...
    const tailwindCSS = (<a key="tailwindCSS" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://tailwindcss.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Tailwind<br/>CSS</span>
    ...
    const git = (<a key="git" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://git-scm.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">Git</span>
    ...
    const gitHub = (<a key="gitHub" className="group m-10 flex flex-col justify-center items-center w-36 h-36" href="https://github.com/" target="_blank" rel="noreferrer">
      <span className="absolute z-3 text-center text-4xl duration-300 font-bold transition-all ease-in group-hover:opacity-100 opacity-0">GitHub</span>
      <div className="w-36 h-36 flex justify-center items-center group-hover:text-[#e98522] text-black">
    ...
    const devSkills = (<div className="flex flex-col items-center relative">
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Languages</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[nextJS, typeScript, vueJS, reactJS, reactRouter, redux, jQuery, javaScript, html, css, tailwindCSS]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Verison Control</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[git, gitHub]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Project Management</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[jira, confluence, trello, agile]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">QA Testing</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[mocha, chai, cypress]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Design</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[adobeCC, figma, sketch]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">AI Productivity</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
    ...
    const uxSkills = (<div className="flex flex-col items-center relative">
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">UI Design</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[adobeCC, figma, sketch]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Coding Languages</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
    ...
    const productSkills = (<div className="flex flex-col items-center relative">
      ...
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Data Analysis</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[tableau, googleAnalytics]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Collaboration</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[slack, microsoftTeams, zoom]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Design Prototyping</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 border border-gray-100 z-1 rounded-[50px] mb-10">
        {[adobeCC, figma, sketch]}
      </div>
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl rounded-b-sm w-3/5">Coding Languages</h2>
