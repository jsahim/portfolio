...
export default function Skills() {
  ...
  const [currSite, setCurrSite] = useState<string>("")
    ...
    const devSkills = (<div className="flex flex-col items-center relative">
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Languages</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[nextJS, typeScript, vueJS, reactJS, reactRouter, redux, jQuery, javaScript, html, css, tailwindCSS]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Version Control</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[git, gitHub]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Project Management</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[jira, confluence, trello, agile]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">QA Testing</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[mocha, chai, cypress]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Design</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[adobeCC, figma, sketch]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">AI Productivity</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
    ...
    const uxSkills = (<div className="flex flex-col items-center relative">
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">UI Design</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[figma, adobeCC, sketch]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Collaboration</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[slack, microsoftTeams, zoom]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Coding Languages</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
      ...
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Data Analysis</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
    ...
    const productSkills = (<div className="flex flex-col items-center relative">
      ...
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Design Prototyping</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 rounded-t-lg rounded-[50px] z-1 mb-14">
        {[adobeCC, figma, sketch]}
      </div>
      <h2 className="text-3xl p-2 text-center font-semibold tracking-wide w-[100%] text-[#304962] z-1 rounded-[50px] px-6 bg-gray-50 mb-2 shadow-md">Coding Languages</h2>
