...
export default function Skills() {
  ...
  const [currSite, setCurrSite] = useState<string>("")
    ...
    const devSkills = (<div className="flex flex-col items-center relative">
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl w-3/5">Languages</h2>
      ...
      <h2 className="text-2xl/6 p-2 font-regular text-white text-center bg-[#304962] z-1 rounded-t-3xl w-3/5">Design</h2>
      <div className="flex flex-wrap justify-center w-full shadow-md bg-gray-50 z-1 rounded-[50px] mb-10">
