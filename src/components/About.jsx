          ...
          <div className="flex flex-col-reverse md:flex-row gap-12 items-center">
            ...
            <div>
              <div className="text-xl text-black space-y-4 leading-relaxed">
                <p><span className="font-medium">Hi, I'm Jeff Sahim - Design Engineer.<br /></span>To truly blend my passion for design and technology, I attended the Turing School of Software & Design, where I completed their immersive program specializing in frontend engineering and UX principles.</p>
