          ...
          <div className="flex flex-col-reverse md:flex-row gap-12 items-center">
            ...
            <div>
              <div className="text-xl text-black space-y-4 leading-relaxed">
                <p><span className="font-medium">Hi, I'm Jeff Sahim.</span> For my entire career, my focus has been on delivering digital products as a client manager. I enjoyed managing these relationships and projects, but I also wanted to contribute more directly to the creation of the products I supported.</p>
                <p>To finally blend my passion for design and technology, I attended the Turing School of Software & Design, where I completed their immersive program specializing in frontend engineering and UX principles.</p>
                <p>Shortly after graduating, I put those skills to immediate use as a UX/UI Developer in the hospitality tech industry. Over the past several years, I've enjoyed collaborating with cross-functional teams to ideate, design, develop, and ship new digital solutions within a fast-paced Agile environment. As I look to the future, I'm actively seeking my next opportunity to deliver impactful products.</p>
                <a className="sm:hidden animated-link py-1 font-lg flex w-fit group justify-start items-center text-xl font-semibold text-black" href="https://drive.google.com/file/d/1JPlJfU8D1ZaMBcKKfk_yxdlKA4SktTuW/view" target="_blank">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-15 md:gap-8">
              ...
              <div className="text-center group hover:transform hover:scale-105 transition-all duration-300 px-5">
                ...
                <h3 className="font-bold text-xl text-white mb-4" style={{ fontFamily: 'Jost, sans-serif', letterSpacing: '0.15em' }}>UX/UI DESIGNER</h3>
              ...
              <div className="text-center group hover:transform hover:scale-105 transition-all duration-300 px-5">
                ...
                <h3 className="font-bold text-xl text-white mb-4" style={{ fontFamily: 'Jost, sans-serif', letterSpacing: '0.15em' }}>PRODUCT MANAGER</h3>
