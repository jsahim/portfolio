          ...
          <div className="flex flex-col-reverse md:flex-row gap-12 items-center">
            ...
            <div>
              <div className="text-xl text-black space-y-4 leading-relaxed">
                <p><span className="font-medium">Hi, I'm Jeff Sahim.</span> For my entire career, I've been in client management, focused on delivering digital products. While I enjoyed managing these relationships and projects, I also wanted to contribute more directly to the build process.</p>
