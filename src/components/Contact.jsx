        ...
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-10 tracking-wider">
              <a className="animated-link py-1 font-lg flex w-fit group justify-start items-center text-xl font-semibold text-white" href="mailto:jeffreysahim@gmail.com">
                <TbMailFilled className="w-6 h-6" />
                <span className="ml-2 font-bold">EMAIL</span> 
              </a>
              <a className="animated-link py-1 font-lg flex w-fit group justify-start items-center text-xl font-semibold text-white" href="https://www.linkedin.com/in/jeff-sahim/" target="_blank">
