const Navigation = ({currentSection, setCurrentSection, scrollToTargetDiv, workSection, aboutSection, contactSection, topSection}) => {
  ...
  return (
    <nav className="tracking-widest fixed flex lg:pt-3 lg:pb-auto pt-auto pb-2 justify-center items-center lg:top-0 lg:bottom-auto top-auto bottom-0 left-0 right-0 z-50 bg-none transition-transform duration-300">
        ...
        <div className="flex justify-center items-center h-14">
          <div className="flex w-full justify-evenly items-center">
            ...
            <a href="https://drive.google.com/file/d/1JPlJfU8D1ZaMBcKKfk_yxdlKA4SktTuW/view?usp=drive_link" target="_blank" 
              className="hidden sm:block hover:bg-gray-600 bg-black py-1 px-2 rounded-sm font-semibold transition-colors text-lg cursor-pointer">
              RESUME
            </a>
