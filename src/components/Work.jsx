    ...
    <section ref={workSection} className="snap-start scroll-mt-0 sm:scroll-mt-10 py-20 px-8 sm:px-10">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className='flex sm:flex-row flex-col justify-center items-center w-full gap-5'>
          ...
          <Link className='pointer-events-auto w-full md:w-1/2 h-[450px] text-black rounded-sm group mb-7 mt-0' to='/snack-shack'>
            ...
            <div className="border-4 h-full group-hover:border-[#f22b40] rounded-2xl transition-colors duration-300">
              <p className='font-medium text-xl leading-[18px] text-gray-700 text-center px-5 pt-5 pb-1'>Mobile Ordering POS</p>
          ...
          <Link className='pointer-events-auto w-full md:w-1/2 h-[450px] text-black rounded-sm group md:mx-7 mb-7 mt-0' to='/mobile-directory'>
            <h3 className="relative text-center translate-y-[16px] w-full font-bold text-xl bg-transparent px-2 text-[#f22b40]">
