  ...
  return (
    <div className="text-black">
      ...
      <div className="space-y-4 grid md:grid-cols-2 gap-15 md:gap-8">
        ...
        <div>
          <p><strong>PROJECT OVERVIEW</strong><br/>This three-week project focused on improving the customer experience and operational efficiency of a local park's concession stand, which suffered from severe queue backups during peak hours, particularly at game halftimes and intermissions.</p>
      ...
      <p>RESULTS & IMPACT<br/>The implementation of the app immediately started to show positive effects on the concession stand operations.</p><br/><br/>
