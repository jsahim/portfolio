...
const SnackShack = () => {
  ...
  return (
    ...
    <div ref={projectTop} className={`transition-all duration-300 ${drawerOpen ? "outline-offset-0 border-[#f22b40] outline-0" : "outline-offset-5 border-black outline-2"}  text-black border-4 outline-[#f22b40] snap-start scroll-mt-5 sm:scroll-mt-25 bg-white rounded-lg md:p-10 p-5`}>
